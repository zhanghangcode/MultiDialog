...
/**
*@date 创建时间 :2018/1/31 18:12
*@author zh_legend
*@Emial code_legend@163.com
*@Description 省市联动的dialog
*@version 1.0
*/
public class RegionPickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public RegionPickerDialog create() {
            final RegionPickerDialog dialog = new RegionPickerDialog(context, params.shadow ? R.style.LoadDialog : R.style.LoadDialog);
